...
urlpatterns = [
    ...
    path('admin/notifications/read/<int:notification_id>/', views.mark_admin_notification_read, name='mark_admin_notification_read'),
    ...
    path('admin/specialties/new/', views.admin_specialty_create, name='admin_specialty_create'),
    path('admin/specialties/create/', views.create_specialty_ajax, name='create_specialty_ajax'),
    path('admin/specialties/search/', views.search_specialties, name='search_specialties'),
    path('admin/specialties/<int:specialty_id>/update/', views.update_specialty, name='update_specialty'),
    path('admin/specialties/<int:specialty_id>/delete/', views.delete_specialty, name='delete_specialty'),
    ...
    path('admin/doctors/<int:doctor_id>/schedule/add/', views.add_hospital_schedule, name='add_hospital_schedule'),
    ...
    path('admin/hospitals/<int:hospital_id>/delete/', views.delete_hospital, name='delete_hospital'),
